      ...
      <Header 
        title="操作日志" 
          ...
          <div v-if="logs.length === 0 && !loading" class="text-center py-12">
            <span class="iconify text-6xl text-gray-300 mx-auto" data-icon="carbon:document-view"></span>
            <p class="mt-4 text-gray-500">暂无日志记录</p>
          </div>
          
          <!-- 加载状态 -->
          <div v-if="loading" class="text-center py-12">
            <span class="iconify text-4xl text-gray-400 animate-spin" data-icon="carbon:circle-dash"></span>
      ...
      >
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-800">{{ selectedLog.adminName || '未知' }} ({{ selectedLog.adminId }})</p>
          </div>
          ...
          <div v-if="selectedLog.details">
            ...
            <pre class="text-sm text-gray-800 bg-gray-50 p-3 rounded border overflow-auto">{{ selectedLog.details }}</pre>
          </div>
