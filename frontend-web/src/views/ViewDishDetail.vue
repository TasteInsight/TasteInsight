      ...
      <div v-else class="space-y-6 mt-6">
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="mb-6">
              ...
              <div
                class="w-full px-4 py-2 border rounded-lg bg-gray-50 text-gray-700 font-medium text-tsinghua-purple"
              >
                ¥{{
                  dishData.price !== null && dishData.price !== undefined
            ...
            <div class="mb-6">
              ...
              <div
                class="w-full px-4 py-2 border rounded-lg bg-gray-50 text-gray-700 min-h-[100px] max-h-[200px] overflow-y-auto"
              >
            ...
            <div>
              ...
              <div v-if="dishData.images && dishData.images.length > 0">
                <!-- 主图展示 -->
                <div
                  class="border-2 rounded-lg aspect-square w-full relative flex items-center justify-center bg-gray-50 overflow-hidden mb-4"
                >
                  <img
                ...
                <div class="flex gap-2 overflow-x-auto pb-2">
                  <div
                    ...
                    :class="{
                      'border-tsinghua-purple': (selectedImage || dishData.images[0]) === img,
                      'border-transparent': (selectedImage || dishData.images[0]) !== img,
                    }"
          ...
          <div>
            ...
            <div class="mb-6">
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <span class="text-tsinghua-purple font-medium">{{
                    item.price ? `¥${item.price}` : '未定价'
                  }}</span>
                </div>
                <div
                  v-if="!dishData.subItems || dishData.subItems.length === 0"
                  class="px-4 py-2 border rounded-lg bg-gray-50 text-gray-500"
                >
                  暂无子项
                </div>
              </div>
            ...
            <div class="mb-6">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <div
                    v-if="dishData.tags && dishData.tags.length > 0"
                ...
                <div>
                  ...
                  <div class="grid grid-cols-4 gap-3">
                    <div>
                      ...
                      <div
                        class="w-full px-3 py-2 border rounded-lg bg-gray-50 text-gray-700 text-sm"
                      >
                        {{
                          dishData.spicyLevel !== null && dishData.spicyLevel !== undefined
                            ? dishData.spicyLevel
                            : 0
                        }}
                      </div>
                    ...
                    <div>
                      ...
                      >
                        {{
                          dishData.saltiness !== null && dishData.saltiness !== undefined
                            ? dishData.saltiness
                            : 0
                        }}
                      </div>
                    ...
                    <div>
                      ...
                      >
                        {{
                          dishData.sweetness !== null && dishData.sweetness !== undefined
                            ? dishData.sweetness
                            : 0
                        }}
                      </div>
                    ...
                    <div>
                      ...
                      >
                        {{
                          dishData.oiliness !== null && dishData.oiliness !== undefined
                            ? dishData.oiliness
                            : 0
                        }}
                      </div>
                ...
                <div class="flex items-center">
                  <span
                    ...
                    :class="
                      ...
                      dishData.availableMealTime.includes('nightsnack')
                        ? 'text-tsinghua-purple'
                        : 'text-gray-300'
                    "
                    data-icon="carbon:checkmark"
            ...
            <div class="mb-6">
              ...
              <div
                v-if="dishData.availableDates && dishData.availableDates.length > 0"
                class="space-y-2"
              >
                <div
        ...
        <div class="border-t border-gray-200 pt-6">
            ...
            <div v-if="reviewsData.rating" class="flex items-center gap-2">
              ...
              <div class="flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-500"
                  >({{ reviewsData.rating.total }}条评论)</span
                >
              </div>
            </div>
          </div>
          ...
          <div v-else-if="reviewsData.items && reviewsData.items.length > 0" class="space-y-4">
            ...
            <!-- 分页 -->
            <div
              v-if="reviewsData.meta && reviewsData.meta.totalPages > 1"
          ...
          <div v-else class="text-center py-10 text-gray-500">暂无评论</div>
        </div>
      </div>
    </div>
  </div>
    ...
    const loadSubDishes = async (subDishIds) => {
      try {
        ...
        dishData.subItems = responses
          .filter(
            (result) =>
              result.status === 'fulfilled' && result.value.code === 200 && result.value.data,
          )
          .map((result) => ({
