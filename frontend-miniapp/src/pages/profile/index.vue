    ...
    <view class="flex-1 px-4 py-4 flex flex-col space-y-4">
      ...
      <view class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        >
          ...
          <!-- 分隔线 (除了最后一项) -->
          <view v-if="index < menuItems.length - 1" class="absolute bottom-0 left-12 right-0 h-[0.5px] bg-gray-100"></view>
        </view>
      </view>
      ...
      <view class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        >
          ...
          <text class="iconify text-gray-400" data-icon="mdi:chevron-right" data-width="20"></text>
          <view class="absolute bottom-0 left-12 right-0 h-[0.5px] bg-gray-100"></view>
        </view>
